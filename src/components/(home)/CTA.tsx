    ...
    return (
        <section className="border-y border-[#3d2e23]">
            <div className="px-4 py-16 lg:py-24 text-center">
                ...
                <p className="text-[#a18072] max-w-2xl mx-auto mb-8">Discover insights about your music listening habits and get ready to connect with friends through TuneStats.</p>
                {session ? (
                    ...
                    <Link href="/api/auth/signin" className="px-8 py-4 bg-[#1DB954] text-[#1e1814] font-bold rounded-lg hover:bg-opacity-90 transition-all inline-flex items-center gap-2 text-lg">Get Started with Spotify <ArrowRight size={20} /></Link>
                )}
            </div>
        </section>
    )
