...
export default function UserData({ session, user, userId }) {
    ...
    return (
        <div className="flex flex-col items-center h-full w-full p-4 bg-[#121212] rounded-lg">
            <img src={user.image === 'unknown' ? 'https://github.com/user-attachments/assets/bf57cb96-b259-4290-b35b-0ede9d618802' : user.image} alt={user.name} className="w-32 h-32 lg:w-1/2 lg:h-auto rounded-full mb-4" />
